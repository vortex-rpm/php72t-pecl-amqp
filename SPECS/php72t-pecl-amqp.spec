...
Summary: find out the amqp of firstnames
...
%description
Gender PHP extension is a port of the amqp.c program originally
written by Joerg Michael. The main purpose is to find out the amqp
...
%changelog
* Fri Oct 05 2018 Ilya Otyutskiy <ilya.otyutskiy@icloud.com> - 1.9.3-1.vortex
- Rebuilt with php72t
